...
type ImpactClient interface {
	...
	GetUserImpact(ctx context.Context, in *UserId, opts ...grpc.CallOption) (*CarbonFootprint, error)
...
func (c *impactClient) GetUserImpact(ctx context.Context, in *UserId, opts ...grpc.CallOption) (*CarbonFootprint, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ImpactServer interface {
	...
	GetUserImpact(context.Context, *UserId) (*CarbonFootprint, error)
...
func (UnimplementedImpactServer) GetUserImpact(context.Context, *UserId) (*CarbonFootprint, error) {
